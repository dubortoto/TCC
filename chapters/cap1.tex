...
A pesquisa parte da premissa de que é esperado que algoritmos de \textit{Deep Learning} apresentem taxas de detecção de intrusão superiores.

Em contrapartida, é esperado que o \textit{Random Forest} apresente desempenho computacional mais eficiente, com menores tempos de treinamento e inferência.
