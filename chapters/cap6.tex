...
O tempo de inferência foi medido sobre o conjunto de teste integral e adotado como estimativa do custo computacional em ambiente de produção. Modelos com menor tempo de inferência são mais adequados para redes com alto volume de tráfego onde a latência de detecção é um requisito operacional \cite{sbrc_minicursos}.
